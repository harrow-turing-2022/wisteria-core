...
xlabel("Size of SCC")
ylabel("Count")
savefig("output/scc_count_dots.pdf", bbox_inches="tight")
cla()
...
xlabel("Size of SCC")
ylabel("Count")
savefig("output/scc_count_crosses.pdf", bbox_inches="tight")
cla()
...
xlabel("Size of SCC")
ylabel("Count")
savefig("output/scc_count_tri.pdf", bbox_inches="tight")
cla()
...
xlabel("Size of SCC")
ylabel("Count")
savefig("output/scc_count_line.pdf", bbox_inches="tight")
cla()
...
xlabel("Size of SCC")
ylabel("Count")
savefig("output/scc_count_bar.pdf", bbox_inches="tight")
cla()
